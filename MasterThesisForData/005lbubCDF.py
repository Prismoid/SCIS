...
### File Open ###
data = np.loadtxt('./Final/z000tsData4100000-4600000.dat')
uncleNum = np.loadtxt('./Final/z000uncleData4100000-4600000.dat')
...
# グラフの描画
plt.plot(time, y1, label="No Delay", color="red")
...
plt.hist(xN, bins=1000,normed=True, histtype='step', cumulative=True, label='Ethereum Classic BC Data', color="green")
...
plt.plot(mean,yPlotProb, marker="o", markersize=4, markeredgecolor="blue", markerfacecolor="white", color='blue', label="Worst Delay(Monte Carlo)")
